...
# Apply CSS styling to the graph container
...
if fl is not None:
    ...
    os.chdir(r"C:\Users\fori.tatama\Desktop\Projects\stream_lit_super_store")
...
# .style.background_gradient(cmap="Oranges")
    ...
    st.subheader(":point_right: Sales by Sub-Category by Month")
    ...
    # get data set top 500
    with st.expander("View Data"):
        st.write(filtered_df.iloc[:500,1:20:2])
    
    # Download whole data set
